...
import com.otongsoetardjoe.freakmangabrandnew.databinding.FragmentNekoDiscoverBinding;
...
public class NekoDiscoverFragment extends Fragment implements NekoNewReleasesInterface {
    private FragmentNekoDiscoverBinding mBinding;
    ...
    private void getNekoData(int pageCount, String hitStatus) {
        ...
        newReleasePresenter.getNekoContent(String.format(Const.BASE_PAGE_NEKO_JAV, pageCount), hitStatus);
    }
